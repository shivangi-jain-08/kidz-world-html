// assigning variable to Add to cart button
var addButtons = document.querySelectorAll("#add-button");

// assigning variable to the span tag showing number of items in cart
var cartValue = document.getElementById("cart-items");

var cartButton = document.getElementById("nav-right");
...
let totalPriceInCents = 0;
    ...
    cartButton.onclick = () => {
        ...
        console.log(
            ...
            window.open("https://wa.me/916232420535?text="+text, "_self")
    };
